...
| `feat/dbos` | DBOS 2.28 | YES in-tx enqueue | YES plain Python workflows |
| `feat/temporal` | Temporal SDK 1.30 | NO fire-after-commit | YES child workflows |
| `feat/prefect` | Prefect 3.8 | NO fire-after-commit | YES .map() |
| `feat/outbox-cdc` | Debezium 3.6 + Kafka | YES outbox in-tx -> CDC | YES via procrastinate worker |
